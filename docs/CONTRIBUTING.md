...
<!--
Pages mirror of the repo's top-level CONTRIBUTING.md. Keep both in sync.
The canonical copy is at the repo root; this one is published as part of
...
project's [MIT license]({{ site.github.repository_url }}/blob/main/LICENSE).
